...
class HungarianMatcher(nn.Module):
    ...
    @torch.no_grad()
    def full_mask_matching(self, outputs, targets):
        """
        Mask Downscaling matching

        Used during evaluation only.
        Deterministically matches predictions to ground truth enabling
        proper geometrical ordering evaluation.
        """
    ...
    def memory_efficient_forward(self, outputs, targets):
        ...
        return [
            ...
            for i, j in indices
        ]  # used for mask reindexing for occlusion pred
